...
// This should match the Scholarship type returned by your API
type Scholarship = {
  id: number;
  slug: string;
  title: string;
...
export default function ScholarshipsPage() {
  ...
  useEffect(() => {
    const fetchScholarships = async () => {
      try {
        const res = await fetch('/api/scholarships'); // Adjust if your API is deployed separately
    ...
    <section className="py-16 px-4 md:px-8 bg-[#f9fafb] min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500 text-lg">No scholarships yet. Check back soon!</p>
        ) : (
              ...
              >
                <Link href={`/scholarships/${scholarship.slug}`}>
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-gray-600 mt-2">{scholarship.excerpt}</p>
