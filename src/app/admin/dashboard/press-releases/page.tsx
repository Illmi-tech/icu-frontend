...
export default function AdminPressReleasesPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6">
      ...
      >
        <h2 className="text-xl font-semibold mb-4">{editingId ? "Edit Press release" : "Create Press release"}</h2>
        ...
        <button
          ...
          disabled={loading}
        >
          {loading ? <Spinner size={2} color="#FFFFFF" /> : editingId ? "Update Press release" : "Create Press release"}
